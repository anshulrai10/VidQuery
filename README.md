...
- 🎯 Entry points to execute your program using `python -m <vidquery>` or `$ vidquery` with basic CLI argument parsing.
...
```bash
pip install vidquery
```

## Usage

```py
from vidquery import BaseClass
from vidquery import base_function
